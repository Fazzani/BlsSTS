...
namespace MembershipRebootUserRepository
{
      ...
      IClaimsRepository
  {
    ...
    {
      var ctx = new MigrateDatabaseToLatestVersion<DefaultMembershipRebootDatabase, BrockAllen.MembershipReboot.Ef.Migrations.Configuration>();
      Database.SetInitializer<DefaultMembershipRebootDatabase>(ctx);
    }
