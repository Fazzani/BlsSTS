...
namespace AdfsIntegrationSampleClient
{
    class Program
    {
        ...
        static string idsrvEndpoint = "http://identityserver.v2.thinktecture.com/idserv";
        static string realm = "http://test/bearer";
        static X509Certificate2 signingCert;

        static void Main(string[] args)
        {
            signingCert = X509.LocalMachine.My.SubjectDistinguishedName.Find("CN=TMA-PC.global.fr", false).First();
